...
describe MembershipTypesController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new MembershipType" do
        expect {
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested membership_type" do
        membership_type = MembershipType.create! valid_attributes
        # Assuming there are no other membership_types in the database, this
  ...
  describe "DELETE destroy" do
    it "destroys the requested membership_type" do
      membership_type = MembershipType.create! valid_attributes
      expect {
